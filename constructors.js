...
function Employee(name, email, hireDate) {
  ...
  */
  ...
  function Car (name, model, year, move) {
    this.name= name;
    this.model= model;
    this.year = year;
    this.move = move;
  ...
  */
  ...
  User.prototype.changePostRating = function (num1, num2) {
    let newRating = this.savedPosts.findIndex(post => num1 === post.id)
    this.savedPosts[newRating].rating = num2
